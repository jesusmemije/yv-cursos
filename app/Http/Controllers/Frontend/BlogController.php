...
class BlogController extends Controller
{
    ...
    public function blogAll()
    {
        ...
        $data['blogs'] = Blog::latest()->take(2)->active()->get();
        $data['recentBlogs'] = Blog::latest()->skip(2)->take(4)->active()->get();
    ...
    public function blogList()
    {
        ...
        $data['metaData'] = staticMeta(5);
        $data['blogs'] = Blog::latest()->active()->paginate(6);

        return view('frontend.blog.blog-list', $data);
    }
    ...
    public function blogDetails($slug)
    {
        ...
        $data['recentBlogs'] = Blog::latest()->take(4)->active()->get();
