...
class VersionUpdateController extends Controller
{
    ...
    public function processUpdate(Request $request)
    {
        ...
        $response = Http::acceptJson()->post('https://support.yessicavilla.com/api/745fca97c52e41daa70a99407edf44dd/active', [
    ...
    public function versionFileUpdate(Request $request)
    {
        ...
        $apiResponse = Http::acceptJson()->post('https://support.yessicavilla.com/api/745fca97c52e41daa70a99407edf44dd/ad', [
            'app' => config('app.app_code'),
            'is_localhost' => env('IS_LOCAL', false),
        ]);
        ...
        if(file_exists($path)){
            ...
            if ($res === true) {
                ...
                try{
                    ...
                    $apiResponse = Http::acceptJson()->post('https://support.yessicavilla.com/api/745fca97c52e41daa70a99407edf44dd/glv', [
                        'app' => config('app.app_code'),
                        'is_localhost' => env('IS_LOCAL', false),
                    ]);
