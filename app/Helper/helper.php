...
function getImageFile($file)
{
    if($file != ''){
        ...
        return asset('frontend/assets/img/no-image.jpg');
    }
}
...
if (!function_exists('getTimeZonesList')) {
    function getTimeZonesList()
    {
        ...
        foreach ($zones as $zone) {
            ...
            $offset = $dt->format('P'); // Gets offset in +00:00 format.
            $ex = explode('/', $zone); // Sometimes zones are like 'Continent/City'.
            $city = end($ex);
            $locations[$zone] = "(GMT{$offset}) {$zone}";
        }
        return $locations;
    }
}
