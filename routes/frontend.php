...
Route::group(['middleware' => 'private.mode'], function () {
    ...
    // Start:: Course
    Route::get('diplomados', [CourseController::class, 'allDiplomas'])->name('diplomas');
    ...
    Route::get('event-details/{slug}', [EventController::class, 'eventDetails'])->name('event-details');
    Route::get('category-events/{slug}', [EventController::class, 'categoryEvents'])->name('categoryEvents');

    Route::get('seach-event-list', [EventController::class, 'searchEventList'])->name('search-event.list');

    Route::get('search-events-by-date', [EventController::class, 'searchEventsByDate']);
    // End:: Events
