...
Route::prefix('course')->group(function () {
    ...
    Route::post('enroll-import', [CourseController::class, 'courseEnrollImport'])->name('admin.course.enroll.import');
});

Route::prefix('main-images')->group(function () {
    Route::get('/', [MainImageController::class, 'index'])->name('admin.main-images.index');
...
Route::prefix('student')->group(function () {
    ...
    Route::post('import', [StudentController::class, 'importStudents'])->name('admin.student.import');
...
Route::group(['prefix' => 'event', 'as' => 'event.'], function () {
    ...
    Route::get('edit/{uuid}', [EventController::class, 'edit'])->name('edit');
    Route::patch('update/{uuid}', [EventController::class, 'update'])->name('update');
    Route::get('delete/{uuid}', [EventController::class, 'delete'])->name('delete');

    // Rutas para la gestión de categorías de eventos
    Route::get('category-index', [EventCategoryController::class, 'index'])->name('category.index');
    Route::post('category-store', [EventCategoryController::class, 'store'])->name('category.store');
    Route::patch('category-update/{uuid}', [EventCategoryController::class, 'update'])->name('category.update');
    Route::get('category-delete/{uuid}', [EventCategoryController::class, 'delete'])->name('category.delete');
});
...
Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
    ...
    Route::get('principal-instructor-video-section-settings', [HomeSettingController::class, 'principalInstructorVideoSection'])->name('principal-instructor-video-section');
