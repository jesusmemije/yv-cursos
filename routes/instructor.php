...
Route::prefix('course')->group(function () {
    ...
    Route::post('import', [CourseController::class, 'importCourses'])->name('instructor.course.import');
    ...
    Route::prefix('lesson')->group(function () {
        ...
        Route::post('import', [LessonController::class, 'importLessonsWithLectures'])->name('instructor.lesson.import');
