...
Route::post('/subscribe-courses', [NewsletterController::class, 'subscribeToCourses'])->name('subscribe.courses');
Route::post('/subscribe-posts', [NewsletterController::class, 'subscribeToPosts'])->name('subscribe.posts');