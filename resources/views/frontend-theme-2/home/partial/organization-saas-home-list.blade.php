<div class="tab-pane fade" id="organization-tab-pane" role="tabpanel" aria-labelledby="organization-tab" tabindex="0">
    ...
    <div class="tab-content" id="organizationpillsContent">
        <div class="tab-pane fade show active overflow-x-scroll" id="pills2-monthly-2" role="tabpanel"
        ...
        <div class="tab-pane fade overflow-x-scroll" id="pills2-yearly-2" role="tabpanel"
