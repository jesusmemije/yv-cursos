<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        <li>
            ...
            <ul>
                <li class="{{ active_if_full_match('admin/main-images') }}">
                    <a href="{{route('admin.main-images.index')}}">
                        <i class="fa fa-circle"></i><span>Lista de Imágenes</span>
                    </a>
                </li>
                <li class="{{ active_if_match('admin/main-images/create') }}">
                    <a href="{{route('admin.main-images.create')}}">
                        <i class="fa fa-circle"></i><span>Agregar Imagen</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        @can('manage_event')
            <li class="{{ @$navEventParentActiveClass }}">
                <a class="has-arrow" href="#">
                    <span class="iconify" data-icon="jam:calendar"></span>
                    <span>{{__('Manage Event')}} </span>
                </a>
                <ul>
                    <li class="{{ active_if_full_match('admin/event/create') }}">
                        <a href="{{route('event.create')}}">
                            <i class="fa fa-circle"></i>
                            <span>{{__('Add Event')}}</span>
                        </a>
                    </li>
                    <li class="{{ active_if_full_match('admin/event') }} {{ active_if_full_match('admin/event/edit/*') }}">
                        <a href="{{route('event.index')}}">
                            <i class="fa fa-circle"></i>
                            <span>{{__('All Event')}}</span>
                        </a>
                    </li>
                    <li class="{{ @$subNavEventCategoryIndexActiveClass }}">
                        <a href="{{route('event.category.index')}}">
                            <i class="fa fa-circle"></i>
                            <span>{{__('Event Category')}}</span>
                        </a>
                    </li>
                </ul>
            </li>
