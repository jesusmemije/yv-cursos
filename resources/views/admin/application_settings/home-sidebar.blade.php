<div class="email__sidebar bg-style">
    <div class="sidebar__item">
        <ul class="sidebar__mail__nav">
            ...
            <li>
                <a href="{{ route('settings.principal-instructor-video-section') }}" class="list-item {{ @$principalInstructorVideoSectionActiveClass }}">
                    <img src="{{ asset('admin/images/heroicon/outline/cog.svg') }}" alt="icon">
                    <span>{{ __('Principal Instructor Video Section') }}</span>
                </a>
            </li>
            <li>
