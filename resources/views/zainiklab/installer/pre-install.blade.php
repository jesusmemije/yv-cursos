...
<div class="section-wrap-body">
    <div class="single-section">
        <h4 class="section-title">Please configure your PHP settings  to match following </h4>
...
{{--            </li>--}}
            <li>
                ...
                <span class="status {{ File::exists(base_path('resources')) && $resource_value == 1 ? '' : 'error' }}">{{ File::exists(base_path('resources')) == 1 && $resource_value == 1 ? 'Ok' : 'Error' }}</span>
            </li>
            <li>
