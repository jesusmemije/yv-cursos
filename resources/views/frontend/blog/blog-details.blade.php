                        ...
                        <div class="blog-page-left-content">
                            ...
                            <div class="blog-item mb-0">
                                <div class="blog-item-bottom-part blog-details-content-wrap">
                                    <h3 class="card-title blog-title mt-4">{{ __($blog->title) }}</h3>
                            ...
                            <div class="block-2">
                                <div class="share-article d-flex align-items-center">
                                    ...
                                    <div class="social-share-box">
                                        ...
                                        <a href="https://www.linkedin.com/shareArticle?url={{ route('blog-details', $blog->slug) }}"rel="me" title="Linkedin" target="_blank">
                                ...
                                <div class="leave-comment-area bg-white">
                                    ...
                                    <form action="#">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group para-color font-14 color-gray mb-30">
                                                    <input type="email" class="form-control email" id="cus_email" required placeholder="{{ __('Your Email *') }}" value="{{ @Auth::user()->email }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div class="sidebar-blog-item-img-wrap overflow-hidden">
                                                        <a href="{{ route('blog-details', $recentBlog->slug) }}">
                                                            <img src="{{ getImageFile($recentBlog->image_path) }}" alt="img" class="img-fluid">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div
                                                    class="flex-grow-1 {{ selectedLanguage()->rtl == 1 ? 'me-3' : 'ms-3' }}">
                                                    <h6 class="sidebar-blog-item-title">
                                                        <a href="{{ route('blog-details', $recentBlog->slug) }}">{{ __(@$recentBlog->title) }}</a>
                                                    </h6>
                                                    <p class="blog-author-name-publish-date font-12 font-medium color-gray mb-0">
