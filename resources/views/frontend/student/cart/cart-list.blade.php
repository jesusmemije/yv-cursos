                        ...
                        <form method="POST" action="{{route('student.goToCheckout')}}">
                            ...
                            <div class="cart-check-terms-condition d-flex my-3">
                                ...
                                <div class="flex-grow-1 ms-1">
                                    Al realizar tu pedido, estás de acuerdo con nuestra 
                                    <a href="{{ route('privacy-policy') }}">política de privacidad</a> y las 
                                    <a href="{{ route('privacy-policy') }}">condiciones</a> de uso de nuestra empresa.
                                </div>
                            </div>
                            @if(count($carts) > 0)
