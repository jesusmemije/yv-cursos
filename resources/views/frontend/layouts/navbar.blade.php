        ...
        <div class="container-fluid">
            ...
            <div class="main-menu-collapse collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="header-nav-left-side me-auto d-flex">                    
                    <form action="#">
                        <div class="input-group landing" style="
                ...
                <div class="header-nav-right-side d-flex">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('diplomas') }}">
                                Diplomados
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('events') }}">{{__('Eventos')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('blogs') }}">{{__('Blog')}}</a>
                        </li>
                        <li class="nav-item">
