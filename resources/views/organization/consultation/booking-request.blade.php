...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-black pb-15"> {{ __('Consultation') }} </h3>
                                    ...
                                    <tr>
                                            ...
                                            <div class="table-data-with-img d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="instructor-student-img-wrap radius-50">
                                                        <img src="{{ getImageFile(@$bookingHistory->user->image_path) }}"
                                                            alt="img" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 table-data-course-name">
                                                    {{ @$bookingHistory->user->student->name }}</div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="red-blue-action-btns">
                                                <button type="button"
                                                    data-route="{{ route('organization.bookingStatus', [$bookingHistory->uuid, 1]) }}"
                                                    class="theme-btn theme-button1 default-hover-btn bookingStatus">{{ __('Approve') }}</button>

                                                <button type="button" data-bs-toggle="modal"
                                                    data-bs-target="#commentReplyModal"
                                                    data-route="{{ route('organization.cancelReason', $bookingHistory->uuid) }}"
            ...
            <div class="modal-content">
                ...
                <form id="cancelReasonForm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group para-color font-14 color-gray nessage-text mb-30">
                                    <textarea name="cancel_reason" rows="3" class="form-control cancel_reason" required
                                        placeholder="Type your cancel reason *"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- Leave a Comment Area-->
                    ...
                    <div class="modal-footer d-flex justify-content-between align-items-center">
                        <button type="button" class="theme-btn theme-button3 modal-back-btn"
