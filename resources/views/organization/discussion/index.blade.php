...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-black pb-15">{{ __('Discussion') }}</h3>
...
@section('content')
                ...
                <div class="col-12 col-md-12 col-lg-12 col-xl-5 col-xxl-4">
                    <div class="instructor-disscussion-page-leftside border-1 radius-4">
                        ...
                        <div class="message-user-list-wrap instructor-discussion-list-wrap custom-scrollbar appendDiscussionCourseList">
                            @include('organization.discussion.render-discussion-course-list')
                        </div>
                    </div>
                </div>
    ...
    <input type="hidden" class="discussionIndexRoute" value="{{ route('organization.discussion.index') }}">
    <input type="hidden" class="courseDiscussionListRoute" value="{{ route('organization.course-discussion.list') }}">
@endsection
