    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-add-question-page instructor-add-true-false-question bg-white">
            ...
            <div class="row">
                ...
                <form action="{{route('organization.exam.save-true-false-question', [$exam->uuid])}}" method="post" class="add-question-form add-true-false-question-form needs-validation" novalidate>
                    @csrf
    ...
    <div class="modal fade" id="bulkUpload" tabindex="-1" aria-labelledby="bulkUpload" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('organization.exam.bulk-upload-true-false', [$exam->uuid])}}" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
