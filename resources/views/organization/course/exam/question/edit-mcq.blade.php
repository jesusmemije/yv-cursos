...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-black pb-15"> {{__('Manage Question')}} </h3>
    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-add-question-page bg-white">
            ...
            <div class="row">
                ...
                <form action="{{route('organization.exam.update-mcq-question', [$question->uuid])}}" method="post" class="add-question-form needs-validation" novalidate>
                    @csrf
