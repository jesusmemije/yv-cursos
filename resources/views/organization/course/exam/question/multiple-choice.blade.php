    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-add-question-page bg-white">
            ...
            <div class="row">
                    ...
                    <form action="{{route('organization.exam.save-mcq-question', [$exam->uuid])}}" method="post" class="add-question-form needs-validation" novalidate>
                        @csrf
    ...
    <div class="modal fade" id="bulkUpload" tabindex="-1" aria-labelledby="bulkUpload" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('organization.exam.bulk-upload-mcq', [$exam->uuid])}}" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
