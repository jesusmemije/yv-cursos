...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-black pb-15"> {{__('My Courses')}} </h3>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14"><a href="{{ route('notice-board.index', $course->uuid) }}">{{__('Notice List')}}</a></li>
                <li class="breadcrumb-item font-14 active" aria-current="page">{{ __('Edit Notice List') }}</li>
            </ol>
        </nav>
    </div>
@endsection
            ...
            <form action="{{ route('notice-board.update', [$course->uuid, $notice->uuid]) }}" method="post">
              ...
              <div class="row mb-30">
                <div class="col-md-12">
                    ...
                    <input type="text" name="topic" class="form-control" placeholder="{{ __('Enter your notice topic') }}" value="{{ $notice->topic }}">
                    @if ($errors->has('topic'))
              ...
              <div class="row mb-30">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="details" cols="30" rows="10" placeholder="{{ __('Enter your notice details') }}">{{ $notice->details }}</textarea>
