...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-black pb-15"> {{__('View Notice')}} </h3>
        ...
        <div class="row">
          <div class="col-12">
              ...
              <div>
                ...
                <a href="{{ route('notice-board.edit', [$course->uuid, $notice->uuid]) }}" class="theme-btn theme-button1 default-hover-btn">{{ __('Edit') }}</a>
              </div>
          </div>
        </div>
      </div>
