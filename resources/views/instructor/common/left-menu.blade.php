<div class="instructor-profile-left-part bg-white">
    <nav class="account-page-menu">
        <ul>
            ...
            <li><a href="{{route('instructor.cycles.index')}}" class="{{active_if_full_match('instructor/cycles')}} {{ @$navCourseActiveClass }}" ><span class="iconify mr-15" data-icon="bx:calendar-event"></span>Ciclos escolares</a></li>
