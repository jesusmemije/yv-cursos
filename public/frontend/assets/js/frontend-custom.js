(function ($) {
    ...
    function initialize_owl(el) {
        $(".direction-ltr .course-slider-items").owlCarousel({
            ...
            nav: true,
            navText: [
                '<img src="frontend/assets/img/arrow-prev.svg" alt="prev">',
                '<img src="frontend/assets/img/arrow-next.svg" alt="next">'
            ],
            responsive: {
                0: {
                    items: 1,
    ...
    // Event Page Slider Owl Carousel Start
    $('.direction-ltr .event-slider-items-wrap').owlCarousel({
        items: 3,
        loop: false,
        margin: 10,
        nav: true,
    ...
    // Event Page Slider Owl Carousel End

    // Testimonials Home Section Owl Carousel Start
    ...
    // Testimonials Home Section Owl Carousel End
