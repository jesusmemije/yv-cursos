function previewFile(input) {
    ...
    if(input.files[0].size > 1000000){
        ...
        reader.onloadend = function() {
            ...
            // Buscar el mensaje de éxito solo dentro del contenedor del perfil
            const container = input.closest('.profile-top');
            const message = container.querySelector('.upload-success');
            if (message) {
                // Cambia el mensaje de éxito y lo muestra
                message.textContent = "Imagen lista: " + file.name + " (haz clic en Guardar)";
